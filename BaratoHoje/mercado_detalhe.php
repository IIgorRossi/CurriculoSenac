...
//pegar o id do mercado transportado pela url
$id = $_GET['id'] ?? 0;
//buscar somentes produtos deste mercado especifico
...
<br>
<h2 class="text-center " style="color: #330672;">Bem-vindo ao </h2>
<br>
...
<section style="background-color: #330672; margin: -1px; border-bottom: 4px solid #f5c63a;">
    <p class="text-center text-white" style="font-size: 20px; padding: 70px;">numero
      endereco, mapa, email 
    </p>
</section>
<br>
